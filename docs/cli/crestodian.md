...
openclaw crestodian --message "setup workspace ~/Projects/work model openai/gpt-5.6-sol" --yes
openclaw crestodian --message "set default model openai/gpt-5.6-sol" --yes
...
validate config
setup
setup workspace ~/Projects/work model openai/gpt-5.6-sol
...
models
set default model openai/gpt-5.6-sol
plugins list
