...
pnpm openclaw qa mantis visual-task \
  ...
  --vision-model openai/gpt-5.6-terra
```
...
pnpm openclaw qa character-eval \
  --model openai/gpt-5.6-sol,thinking=medium,fast \
...
`openai/gpt-5.6-sol`, `openai/gpt-5.5`, `openai/gpt-5.2`, `anthropic/claude-opus-4-8`,
