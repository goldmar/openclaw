...
export function buildOpenAIProvider(): ProviderPlugin {
  ...
  return {
    ...
    buildMissingAuthMessage: (ctx) => {
      ...
      return 'No API key found for provider "openai". You are authenticated with OpenAI ChatGPT/Codex OAuth. Use openai/gpt-5.6-sol with the ChatGPT/Codex OAuth profile, or set OPENAI_API_KEY for direct OpenAI API access.';
    },
